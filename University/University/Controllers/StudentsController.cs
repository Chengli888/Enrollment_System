...
namespace University.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstMidName,Enrollment")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstMidName,Enrollment")] Student student)
        {
            if (ModelState.IsValid)
            {
